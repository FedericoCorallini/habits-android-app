...
import com.fcorallini.home_data.R
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    @Inject
    lateinit var repository: com.fcorallini.home_domain.repository.HomeRepository
    ...
    private fun showNotification(habit: com.fcorallini.home_domain.model.Habit, context: Context) {
        val notificationManager = context.getSystemService(NotificationManager::class.java)
